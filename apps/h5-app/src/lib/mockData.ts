...
export const mockCompanies: Company[] = [
  {
    ...
    directors: [{ id: 'dir_001', name: '陈董', nationality: '中国', appointedDate: '2024-01-20' }],
    shareholders: [{ id: 'shr_001', name: '陈董', shares: 10000, percentage: 100 }],
  ...
  },
  {
    ...
    directors: [{ id: 'dir_004', name: '陈董', nationality: '中国', appointedDate: '2024-06-01' }],
    shareholders: [
...
export const mockExchangeRates: ExchangeRate[] = [
  ...
  { from: 'USD', to: 'HKD', rate: 7.789, timestamp: '2024-12-19T12:00:00', change24h: 0.01 },
  { from: 'USD', to: 'JPY', rate: 149.5, timestamp: '2024-12-19T12:00:00', change24h: -0.45 },
...
export const mockTaxRates: TaxRate[] = [
  ...
  },
  {
    ...
    withholdingTax: 0,
    capitalGainsTax: 0,
    doubleTaxationTreaties: ['CN', 'GB', 'DE', 'FR', 'SG'],
    notes: '属地征税，离岸收入免税',
  },
  {
    id: 'tax_003',
    country: '新加坡',
    countryCode: 'SG',
    structureType: '私人有限公司',
    corporateTax: 17,
    vatGst: 9,
    withholdingTax: 15,
    capitalGainsTax: 0,
    doubleTaxationTreaties: ['CN', 'HK', 'GB', 'DE', 'AU', 'IN'],
    notes: '首30万新币利润有税务优惠',
  },
  {
    id: 'tax_004',
    ...
    withholdingTax: 30,
    capitalGainsTax: 21,
    doubleTaxationTreaties: ['CN', 'GB', 'DE', 'JP', 'CA'],
    notes: '联邦税+州税，总税率约25-30%',
  },
  {
    id: 'tax_005',
    country: '英国',
    ...
    withholdingTax: 0,
    capitalGainsTax: 25,
    doubleTaxationTreaties: ['CN', 'US', 'DE', 'FR', 'SG', 'HK'],
    notes: '利润超过25万英镑适用25%税率',
  },
  {
    id: 'tax_006',
    country: '日本',
    ...
    withholdingTax: 20,
    capitalGainsTax: 15,
    doubleTaxationTreaties: ['CN', 'US', 'GB', 'DE', 'SG', 'HK'],
    notes: '法人税+住民税+事业税，实际约30%',
  },
  {
    id: 'tax_007',
    country: '德国',
    ...
    withholdingTax: 25,
    capitalGainsTax: 25,
    doubleTaxationTreaties: ['CN', 'US', 'GB', 'FR', 'JP', 'SG'],
    notes: '加上团结附加税和贸易税，实际约30-33%',
  },
  {
    id: 'tax_008',
    country: '阿联酋',
    countryCode: 'AE',
    structureType: ' mainland',
    corporateTax: 9,
    vatGst: 5,
    withholdingTax: 0,
    capitalGainsTax: 0,
    doubleTaxationTreaties: ['CN', 'IN', 'GB', 'DE'],
    notes: '2023年起超过37.5万迪拉姆利润征9%企业税',
  },
  {
    id: 'tax_009',
    country: '澳大利亚',
    countryCode: 'AU',
    structureType: 'Pty Ltd',
    corporateTax: 25,
    vatGst: 10,
    withholdingTax: 30,
    capitalGainsTax: 25,
    doubleTaxationTreaties: ['CN', 'US', 'GB', 'JP', 'SG'],
    notes: '基准企业税率25%',
  },
  {
    id: 'tax_010',
    ...
    withholdingTax: 25,
    capitalGainsTax: 25,
    doubleTaxationTreaties: ['CN', 'US', 'GB', 'DE', 'JP'],
    notes: '联邦税15%+省税，实际约25-31%',
  },
  {
    id: 'tax_011',
    country: 'BVI',
  ...
  },
  {
    ...
    withholdingTax: 10,
    capitalGainsTax: 20,
    doubleTaxationTreaties: ['HK', 'SG', 'US', 'GB', 'DE', 'JP'],
    notes: '高新技术企业15%优惠税率',
  },
  {
    id: 'tax_014',
    country: '越南',
    countryCode: 'VN',
    structureType: '有限责任公司',
    corporateTax: 20,
    vatGst: 10,
    withholdingTax: 10,
    capitalGainsTax: 20,
    doubleTaxationTreaties: ['CN', 'SG', 'JP', 'DE'],
    notes: '经济区企业可享10-17%优惠',
  },
  {
    id: 'tax_015',
    country: '泰国',
    ...
    withholdingTax: 15,
    capitalGainsTax: 15,
    doubleTaxationTreaties: ['CN', 'SG', 'JP', 'DE', 'AU'],
    notes: 'BOI促进项目可享免税期',
  },
  {
    id: 'tax_016',
    ...
    withholdingTax: 10,
    capitalGainsTax: 24,
    doubleTaxationTreaties: ['CN', 'SG', 'JP', 'GB', 'DE', 'AU'],
    notes: '中小企业首60万马币可享15-17%',
  },
  {
    id: 'tax_017',
    country: '印尼',
    ...
    withholdingTax: 20,
    capitalGainsTax: 25,
    doubleTaxationTreaties: ['CN', 'SG', 'JP', 'AU', 'DE'],
    notes: '上市企业可降至19%',
  },
  {
    id: 'tax_018',
  ...
  },
  {
    ...
    withholdingTax: 30,
    capitalGainsTax: 15,
    doubleTaxationTreaties: ['CN', 'JP', 'SG', 'DE'],
    notes: 'PEZA经济区企业可享4-17%',
  },
  {
    id: 'tax_020',
    country: '瑞士',
    ...
    withholdingTax: 35,
    capitalGainsTax: 0,
    doubleTaxationTreaties: ['CN', 'US', 'GB', 'DE', 'JP', 'SG'],
    notes: '联邦+州+市镇税，实际约12-21%',
  },
  {
    id: 'tax_021',
    country: '荷兰',
    ...
    vatGst: 21,
    withholdingTax: 15,
    capitalGainsTax: 25.8,
    doubleTaxationTreaties: ['CN', 'US', 'GB', 'DE', 'JP', 'SG', 'HK'],
    notes: '创新盒子制度可享有效7%税率',
  },
];
...
export const mockLegalCompliance: LegalCompliance[] = [
  {
    ...
    countryCode: 'WS',
    category: '公司注册',
    requirement: '至少一名董事和一名股东',
    description: '可以是自然人或法人，无国籍限制',
    penalty: '公司注册申请被拒绝',
    status: 'required',
  },
  {
    ...
    countryCode: 'WS',
    category: '年度合规',
    requirement: '年度申报和牌照费',
    description: '每年需提交年度申报并缴纳牌照费',
    penalty: '罚款及可能的除名',
    status: 'required',
  },
  {
    ...
    category: '经济实质',
    requirement: '经济实质法案',
    description: '从事相关活动的公司需证明在萨摩亚有足够经济实质',
    penalty: '罚款最高10万美元',
    status: 'required',
  },
  {
    ...
    countryCode: 'WS',
    category: '反洗钱',
    requirement: 'KYC/AML程序',
    description: '需维持有效的了解客户和反洗钱程序',
    penalty: '刑事责任及高额罚款',
    status: 'required',
  },
  {
  ...
  },
  {
    ...
    countryCode: 'SG',
    category: '公司注册',
    requirement: '至少一名本地董事',
    description: '至少一名董事需为新加坡居民',
    penalty: '注册被拒绝',
    status: 'required',
  },
  {
    ...
    category: '税务',
    requirement: 'GST注册',
    description: '年营业额超过100万新币需注册GST',
    penalty: '罚款最高1万新币',
    status: 'required',
  },
  {
  ...
  },
  {
    ...
    category: '合规',
    requirement: 'BOI报告',
    description: '2024年起需向FinCEN报告受益所有人信息',
    penalty: '每日500美元罚款',
    status: 'required',
  },
  {
    ...
    countryCode: 'GB',
    category: '公司注册',
    requirement: 'Companies House注册',
    description: '必须在Companies House注册',
    penalty: '无法合法经营',
    status: 'required',
  },
  {
    ...
    countryCode: 'GB',
    category: '税务',
    requirement: 'Corporation Tax',
    description: '必须注册并缴纳公司税',
    penalty: '罚款及利息',
    status: 'required',
  },
  {
  ...
  },
  {
    ...
    category: '经济实质',
    requirement: '经济实质法',
    description: '从事相关活动的公司需证明有足够经济实质',
    penalty: '罚款及可能的注销',
    status: 'required',
  },
];
...
export const mockVideoComments: VideoComment[] = [
  {
    ...
    userName: '张总',
    userAvatar: '',
    content: '非常详细的讲解，已经注册了萨摩亚公司，流程确实很快！',
    likes: 45,
...
export const mockMediaPosts: MediaPost[] = [
  {
    id: 'post_001',
    title: '萨摩亚SPV注册指南2024版',
    content: '详细解析萨摩亚SPV的优势与注册流程...',
    platform: 'wechat',
    status: 'published',
    publishedAt: '2024-12-18',
    aiGenerated: true,
    engagement: { impressions: 12500, clicks: 890, likes: 456, shares: 234, comments: 67 },
  },
  {
    id: 'post_002',
    title: '全球税务优化五大策略',
    content: '企业出海必知的税务优化方法...',
    platform: 'tiktok',
    status: 'published',
    publishedAt: '2024-12-17',
    aiGenerated: false,
    engagement: { impressions: 8900, clicks: 1200, likes: 678, shares: 345, comments: 89 },
  },
  {
    id: 'post_003',
    title: 'AI大脑：你的智能出海合伙人',
    content: '太初国链AI大脑功能全面解析...',
    platform: 'xiaohongshu',
    status: 'scheduled',
    scheduledAt: '2024-12-20T10:00:00',
    aiGenerated: true,
    engagement: { impressions: 0, clicks: 0, likes: 0, shares: 0, comments: 0 },
  },
  {
    id: 'post_004',
    title: '东南亚电商市场Q4报告',
    content: '2024年Q4东南亚六国电商数据...',
    platform: 'weibo',
    status: 'draft',
    aiGenerated: false,
    engagement: { impressions: 0, clicks: 0, likes: 0, shares: 0, comments: 0 },
  },
  {
    id: 'post_005',
    title: '跨境收款通道对比',
    content: 'Visa、USDT、本地支付全面对比...',
    platform: 'wechat',
    status: 'published',
    publishedAt: '2024-12-15',
    aiGenerated: true,
    engagement: { impressions: 15600, clicks: 1100, likes: 567, shares: 289, comments: 78 },
  },
];
...
export const mockNotifications: Notification[] = [
  {
    id: 'notif_001',
    title: '年审提醒',
    message: '太初国际（萨摩亚）有限公司年度申报将于30天后到期，请及时处理。',
    type: 'warning',
    read: false,
    timestamp: '2024-12-19T09:00:00',
    actionUrl: '/documents',
  ...
  },
  {
    id: 'notif_003',
    title: 'AI建议',
    message: '智财管家建议调整新加坡子公司利润分配方案，预计可节省税费15%。',
    type: 'info',
    read: false,
    timestamp: '2024-12-18T16:00:00',
    actionUrl: '/ai-chat/agent_001',
  },
  {
    id: 'notif_004',
    title: '新功能上线',
    message: 'AI大脑新增「合同审查」功能，可自动识别合同风险条款。',
    type: 'info',
    read: true,
  ...
  },
  {
    id: 'notif_006',
    title: 'DLC升级',
    message: '恭喜！您的DLC等级已提升至「黄金LV.6」，解锁更多专属权益。',
    type: 'success',
    read: true,
  ...
  },
  {
    id: 'notif_007',
    title: '汇率变动',
    message: 'USD/CNY 汇率上涨0.12%，建议关注换汇时机。',
    type: 'info',
    read: true,
  ...
  },
  {
    id: 'notif_008',
    title: '系统维护',
    message: '系统将于12月22日凌晨2:00-4:00进行维护，部分功能可能受影响。',
    type: 'warning',
    read: true,
