      ...
      <div className="sticky top-0 z-40 bg-bg-dark/95 backdrop-blur-xl border-b border-white/[0.06]">
        <div className="flex items-center justify-between px-4 h-12">
          <button
            ...
            className="w-9 h-9 flex items-center justify-center rounded-lg active:bg-white/5"
          >
          ...
          {tabs.map((tab, i) => (
            <button
              ...
              className={cn(
                ...
                activeTab === i ? 'text-coral' : 'text-text-muted'
              )}
            >
              {tab}
              {activeTab === i && (
                <motion.div
                  layoutId="aiCardTab"
                  className="absolute bottom-0 left-1/4 right-1/4 h-0.5 bg-coral rounded-full"
                />
              )}
            </button>
          ))}
        ...
        {activeTab === 0 && (
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background: 'linear-gradient(135deg, #0A2540 0%, #1a1a2e 50%, #0A0E1A 100%)',
            ...
            >
              ...
              <div className="flex items-start gap-4 relative z-10">
                <div
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #F6A623, #CE1126)',
                    padding: '2px',
                  }}
                >
            ...
            >
              {[
                ...
                <div
                  key={i}
                  className="bg-bg-card rounded-xl p-3 text-center border border-white/[0.06]"
                >
              ...
              <div className="grid grid-cols-4 gap-3">
                {[
                  ...
                  { icon: Smartphone, label: 'NFC', color: '#00D4AA' },
                  {
                    ...
                    label: '链接',
                    color: '#60A5FA',
                    action: () => copyToClipboard('https://taichu.com/card/ceo'),
                  },
                ].map((item, i) => (
                  <button
                    key={i}
          ...
          >
            ...
            <div className="space-y-3">
              ...
              {filteredCards.length === 0 && (
                <div className="text-center py-12 text-text-muted text-body-sm">
                  未找到匹配的名片
                </div>
              )}
            </div>
        ...
        {activeTab === 2 && (
          ...
          >
                  ...
                  >
                    <p
                      className={cn(
                        ...
                        aiStyle === style.id ? 'text-coral' : 'text-text-primary'
                      )}
                    >
                      {style.label}
                    </p>
            ...
            <button
              ...
              disabled={aiGenerating || !aiForm.name}
              className={cn(
                'w-full h-12 rounded-xl font-semibold text-body-sm transition-all',
        ...
        {showQrModal && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1 }}
              exit={{ scale: 0.9 }}
              className="bg-bg-card rounded-2xl p-6 w-full max-w-[280px] text-center border border-white/[0.06]"
            ...
            >
              ...
              <button
                onClick={() => setShowQrModal(false)}
                className="mt-4 px-6 py-2 bg-bg-elevated rounded-lg text-[13px] text-text-secondary"
              >
                关闭
              </button>
            </motion.div>
        ...
        {showShareModal && (
          ...
          >
            <motion.div
              ...
              animate={{ y: 0 }}
              exit={{ y: 300 }}
              className="w-full bg-bg-card rounded-t-2xl p-6 border-t border-white/[0.06]"
              onClick={(e) => e.stopPropagation()}
            >
              ...
              <button
                onClick={() => setShowShareModal(false)}
                className="w-full h-12 mt-4 bg-bg-elevated rounded-xl text-body-sm text-text-secondary"
              >
                取消
              </button>
            </motion.div>
