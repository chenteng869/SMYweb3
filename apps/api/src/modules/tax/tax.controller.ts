...
export class TaxController {
  ...
  @Get('rates')
  @ApiOperation({ summary: '税率列表' })
  list(@Query() q: any) {
    return this.svc.list(q);
  }

  @Get('rates/:id')
  @ApiOperation({ summary: '税率详情' })
  detail(@Param('id', ParseIntPipe) id: number) {
    return this.svc.detail(id);
  }

  @Post('rates')
  @ApiOperation({ summary: '创建税率' })
  ...
  @Post('calculate')
  @ApiOperation({ summary: '税务计算' })
  calculate(@Body() body: any) {
    return this.svc.calculate(body);
  }
}
