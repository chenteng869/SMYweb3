...
export class AiController {
  ...
  // Agents
  @Get('agents')
  @ApiOperation({ summary: 'AI 顾问列表' })
  listAgents(@Query() q: any) {
    return this.svc.listAgents(q);
  }

  @Get('agents/:id')
  @ApiOperation({ summary: 'AI 顾问详情' })
  agentDetail(@Param('id', ParseIntPipe) id: number) {
    return this.svc.agentDetail(id);
  }

  @Post('agents')
  @ApiOperation({ summary: '创建 AI 顾问' })
  ...
  // Messages
  @Get('messages')
  @ApiOperation({ summary: 'AI 对话记录' })
  listMessages(@Query() q: any) {
    return this.svc.listMessages(q);
  }

  // Todos
  @Get('todos')
  @ApiOperation({ summary: 'AI Todo 列表' })
  listTodos(@Query() q: any) {
    return this.svc.listTodos(q);
  }

  // Knowledge
  @Get('knowledge')
  @ApiOperation({ summary: 'AI 知识库列表' })
  listKnowledge(@Query() q: any) {
    return this.svc.listKnowledge(q);
  }
