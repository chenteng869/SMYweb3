...
export class SystemController {
  ...
  configs(@Query('group') group?: string) {
    return this.svc.listConfigs(group);
  }
  ...
  async createAdmin(@Body() body: any, @Req() req: any, @CurrentUser() user: any) {
    ...
    await this.audit.log(req, user.id, 'create_admin', 'system', String(r.id), {
