...
export class LegalController {
  constructor(
    private svc: LegalService,
    private audit: AuditService
  ) {}

  // Compliance
  @Get('compliance')
  @ApiOperation({ summary: '合规项列表' })
  listCompliance(@Query() q: any) {
    return this.svc.listCompliance(q);
  }

  @Post('compliance')
  @ApiOperation({ summary: '创建合规项' })
  ...
  listContracts(@Query() q: any) {
    return this.svc.listContracts(q);
  }
